...
import GamificationWidget from "../../components/GamificationWidget"; // ✅ Adjusted path
import Snowflakes from "../../components/Snowflakes"; // Adjust path if needed
    ...
    <>
     <Snowflakes /> 
      ...
      {loading ? (
        ...
        <>
          <Container
            style={{ position: "relative", zIndex: "2 !important", backgroundColor:'white'  }}
            className="mt-3"
          >
